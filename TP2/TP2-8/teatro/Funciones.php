...
public function __toString()
{
    ...
    $cadena = $cadena." horario de funcion: ".$this->getHorarioInicio()."\n";
    $cadena = $cadena." duracion de funcion: ".$this->getDuracionObra()."\n";
    $cadena = $cadena." precio de funcion: ".$this->getPrecio()."\n";
